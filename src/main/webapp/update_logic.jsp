...
<title>Update Data Logic | Admin</title>
...
<body>
	...
	<sql:update dataSource="${con}" var="rs">  
		update data set Specifications=? where Floor_no=? and Lab_no=? and Name=? 
	
	<sql:param value="${param.spec}"></sql:param>
		<sql:param value="${param.fn}"></sql:param>
