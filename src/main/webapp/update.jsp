...
<body>
	...
	<h2
		style="text-align: center; font-family: calibri; font-weight: 700; margin-bottom: -50px;">Update
		Devices</h2>
							...
							<form action="update_logic.jsp">
								...
								<div class="row align-items-center py-3">
									<div class="col-md-3 ps-5">
										...
										<h6 class="mb-0">Updated Specifications</h6>
