...
<jsp:include page="admin_navbar.jsp" /><br><br><br><br>
	...
	<h2 style="text-align: center; font-family: calibri; font-weight: 700; margin-bottom: -10px;">Add Labs</h2>
						...
						<div class="card-body">
							<form action="add_lab_logic.jsp">
								...
								<div class="px-1 py-4" style="margin-left: 300px;">
									<button type="submit" class="btn btn-primary btn-lg">Add Lab</button>
								</div>
							</form>
						</div>
					</div>
