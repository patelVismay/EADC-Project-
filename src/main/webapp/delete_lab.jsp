...
<jsp:include page="admin_navbar.jsp" /><br><br><br><br>
	...
	<h2 style="text-align: center; font-family: calibri; font-weight: 700; margin-bottom: -10px;">Delete Labs</h2>
			...
			<div class="row d-flex justify-content-center align-items-center h-10">
				<div class="col-xl-9">
					<div class="card" style="border-radius: 15px;">
						<div class="card-body">
							<form action="delete_lab_logic.jsp">								
								...
								<div class="px-1 py-4" style="margin-left: 300px;">
									<button type="submit" class="btn btn-primary btn-lg">Delete Lab</button>
								</div>
							</form>
						</div>
					</div>
